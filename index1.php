	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<form class="login100-form validate-form" name="frmRegistration"method="post" action="validate2.php">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						...
						<span id="txtEmailFailed" class="<?php echo $_SESSION['errors']['txtEmail'] ?>"> Invalid e-mail address or wrong input.</span> 
					...
					<div class="wrap-input100 rs1 validate-input" data-validate="Password is required">
						...
						<span id="txtPasswordFailed" class="<?php echo $_SESSION['errors']['txtPassword'] ?>"> Invalid password or wrong input.</span> 
						<span class="focus-input100-2"></span>
					</div>
